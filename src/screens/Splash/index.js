...
const Splash = ({navigation}) => {
    ...
    return ( 
        ...
        <View style={styles.container}>
            ...
            <Text style={styles.subtitle}>Simple way to find Tasty Recipe with Ate Bubles</Text>
            <Button style={styles.button} onPress={() => navigation.navigate('Home')}>Start Cooking</Button>
        </View>
        </ImageBackground>
    )
  }
